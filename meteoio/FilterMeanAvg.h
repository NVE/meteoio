...
class FilterMeanAvg : public FilterBlock {
	public:
	...
	private:
		...
		double calc_avg(const unsigned int& index, std::vector<const MeteoData*>& vec_window);

		bool is_soft;
		double min_data_points;
		Date min_time_span;
		WindowOrientation centering;
};
