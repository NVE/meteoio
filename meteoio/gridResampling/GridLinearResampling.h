...
class GridLinearResampling : public GridResamplingAlgorithm {
	public:
		GridLinearResampling(const std::string& algoname, const std::string& parname, const double& dflt_window_size, const std::vector< std::pair<std::string, std::string> >& vecArgs);
