...
const double TauCLDGenerator::soil_albedo = .23; //grass
const double TauCLDGenerator::snow_albedo = .85; //snow
const double TauCLDGenerator::snow_thresh = .1; //if snow height greater than this threshold -> snow albedo
