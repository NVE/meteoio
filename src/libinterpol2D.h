 ...
 * Each parameter to be interpolated declares which interpolation method to use for single and multiple data sources. Then the class computes the interpolation for each 2D grid point, combining the inputs provided by the available data sources.
